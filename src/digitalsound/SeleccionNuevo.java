 ...
 * @author Usuario
 */
public class SeleccionNuevo extends javax.swing.JFrame {
    Empleados mEmpleados = new Empleados();
    /**
     * Creates new form SeleccionNuevo
     * @param empleado
     */
    public SeleccionNuevo(Empleados empleado) {
        initComponents();
        configurarVentana();
        mEmpleados = empleado;
    }
    private void configurarVentana(){
        ...
        this.setTitle("Digital Sound - Seleccion");
    ...
    private void initComponents() {
        ...
        jPanel4.setBackground(new java.awt.Color(208, 31, 36));
        ...
        btn_registrar.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ListaClientes lista = new ListaClientes(mEmpleados);
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        RegistroCliente registroC = new RegistroCliente(mEmpleados);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionNuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Empleados mEmpleados = new Empleados();
                new SeleccionNuevo(mEmpleados).setVisible(true);
            }
        });
    }
