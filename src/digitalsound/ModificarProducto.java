...
public class ModificarProducto extends javax.swing.JFrame {
     ...
     */
    public ModificarProducto(String idProducto,ConsultaProductos consulta, Empleados empleados) {
        initComponents();
        configurarVentana();
    ...
    private void initComponents() {
        ...
        btn_registro.setText("Modificar producto");
    ...
    private void btn_registroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registroActionPerformed
        ...
        try{
            if(txt_nombre.getText().trim().length() != 0){
                ...
                pst = con.prepareStatement("CALL modificar_producto_datos(?, ?, ?, ?, ?, ?)");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ModificarProducto("0",mConsulta, mEmpleados).setVisible(true);
            }
        });
    }
    private void llenarDatos() throws SQLException{
        ...
        ResultSet rs = null;
        try{
            String idProducto = lbl_id.getText().trim();
            con = dsm.getDataSource().getConnection();
            pst = con.prepareStatement("SELECT * FROM productos WHERE idProducto = ?;"); //cambiar a procedimiento almacenado
            pst.setString(1, idProducto); //idProducto
            rs = pst.executeQuery();
            while(rs.next()){
                Producto mProducto = new Producto();
                txt_codigo.setText(rs.getString("idProducto"));
                txt_nombre.setText(rs.getString("NombreProducto"));
                txt_descripcion.setText(rs.getString("Descripcion"));
                txt_precio.setText(rs.getString("Precio"));
                mProducto.setIdTipo(rs.getInt("Productos_idTipo"));
                int idTipo = mProducto.getIdTipo();
                for (int i = 0; i < cb_tipo.getItemCount(); i++) {
                    TipoProducto tipoProducto = cb_tipo.getItemAt(i);
                    if (tipoProducto.getIdTipo() == idTipo) {
                        cb_tipo.setSelectedIndex(i);
                        break;
                    }
                }
                mProducto.setFecha(rs.getString("FechaLanzamiento"));
                mProducto.setEstado(rs.getInt("EstadoProductos"));                
            }
